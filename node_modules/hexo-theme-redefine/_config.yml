...
defaults:
  # Favicon
  favicon: https://avatars.githubusercontent.com/u/227128491
  # Site logo
  logo: 
  # Site avatar
...
global:
  ...
  preloader:
    enable: true
    custom_message: 不以物喜，不以己悲 # Custom message. If empty, the site title will be displayed
  # Side tools settings
  side_tools:
...
home_banner:
  ...
  subtitle:
    text: ["不","不以","不以物","不以物喜","不以物喜，","不以物喜，不","不以物喜，不以","不以物喜，不以己","不以物喜，不以己悲",] # subtitle text, array
    hitokoto:  # 一言配置
    ...
    typing_speed: 30 # Typing speed (ms)
  ...
  social_links:
    ...
    # Social links
    links:
      github: https://github.com/Zarijaden # your GitHub URL
      instagram: https://instagram.com/Zarijaden # your Instagram URL
      zhihu:  # your ZhiHu URL
      fa-brands fa-x-twitter: https://x.com/Zarijaden_1726 # your twitter URL
      fa-brands fa-x-bilibili: https://space:bilibili.com/3493135097269095
      email: Zarijaden@163.com # your email
      # ...... # you can add more
